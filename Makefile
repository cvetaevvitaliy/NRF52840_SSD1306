...
PROJ_DIR := ${PWD}
SDK_ROOT := ${PROJ_DIR}/SDK


$(OUTPUT_DIRECTORY)/nrf52840_xxaa.out: \
  LINKER_SCRIPT  := ${PROJ_DIR}/template_gcc_nrf52.ld
...
SRC_FILES += \
  ...
  $(PROJ_DIR)/ssd1306/ssd1306.c \
  $(PROJ_DIR)/ssd1306/Fonts/Font_8x10.c
...
INC_FOLDERS += \
  ...
  $(PROJ_DIR)/ssd1306 \
  $(PROJ_DIR)/ssd1306/Image \
  $(PROJ_DIR)/ssd1306/Fonts \
